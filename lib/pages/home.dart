      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(Icons.location_on, color: Color.fromARGB(255, 14, 13, 0)),
                Text(
                  "123 Main St",
            ...
            SizedBox(height: 20.0),
            Text("Category", style: AppWidget.boldTextstyle(22, Colors.black)),
                  ...
                  child: Stack(
                    children: [
                      ClipRRect(
                        borderRadius: BorderRadius.circular(15),
                        child: Image.asset(
                          "image/jannes-glas-0NaQQsLWLkA-unsplash.jpg",
                          height: 120,
                          width: 120,
                          fit: BoxFit.cover,
